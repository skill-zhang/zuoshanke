...
ICON_RULES = [
    ...
    # ── 2026-05-30 第三轮扩充（覆盖高频缺失的类别/场景名）──
    (["科技", "技术", "IT", "互联网", "数码", "电子设备"], "🔧"),
    (["手机", "平板", "电脑", "笔记本", "3C"], "📱"),
    (["美容", "美妆", "护肤", "化妆", "医美", "整形", "穿搭"], "💄"),
    (["母婴", "育儿", "亲子", "宝宝", "儿童", "早教", "孕", "孕期"], "👶"),
    (["保险", "社保", "医保", "保单", "理赔"], "🛡️"),
    (["快递", "配送", "货运", "搬家", "发货"], "🚚"),
    (["酒店", "住宿", "民宿", "宾馆", "青旅"], "🏨"),
    (["翻译", "语言", "外语", "英语", "口语", "小语种"], "🗣️"),
    (["留学", "签证", "移民", "护照", "出入境"], "🛂"),
    (["婚礼", "婚庆", "婚纱", "结婚", "婚恋", "相亲"], "💒"),
    (["星座", "运势", "占卜", "风水", "玄学", "算命", "塔罗"], "🔮"),
    (["带货", "主播", "网红"], "📡"),
    (["农业", "种植", "养殖", "农产品", "农村", "农民"], "🌾"),
    (["咖啡", "茶饮", "奶茶", "果汁", "饮品", "调酒"], "☕"),
    (["棋牌", "桌游", "麻将", "扑克", "象棋", "围棋"], "♟️"),
    ...
    (["珠宝", "首饰", "手表", "奢侈品", "钻石", "翡翠"], "💎"),
    (["安全", "隐私", "密码", "加密", "防护", "防火墙"], "🔒"),
    (["政府", "政务", "公务员", "政策", "行政", "办事大厅", "政务中心"], "🏛️"),
    (["公益", "志愿者", "慈善", "捐款", "捐赠"], "❤️"),
    (["养老", "老年", "退休", "敬老", "康养"], "👴"),
    (["武术", "太极", "格斗", "拳击", "跆拳道", "散打"], "🥋"),
    (["环保", "能源", "绿色", "低碳", "可持续", "生态", "碳中和"], "♻️"),
    (["花艺", "园林", "植物", "多肉", "插花"], "🌸"),
    (["家政", "保洁", "收纳", "清洁", "打扫", "清洗"], "🧹"),
    (["营销", "推广", "广告", "品牌", "市场", "销售", "促销"], "📣"),
    (["银行", "转账", "汇款", "贷款", "信用卡", "开户"], "🏦"),
    (["烹饪", "烘焙", "煮饭", "厨艺", "厨房", "做饭"], "🍳"),
    (["交通", "公交", "地铁", "火车", "高铁", "通勤"], "🚄"),
    (["日记", "笔记", "日志", "随笔", "手账"], "📓"),
    ...
    # ── 2026-05-30 补丁（第二轮新增缺失高频词）──
    (["周报", "日报", "月报", "周报生成", "日报助手", "汇报"], "📋"),
    (["记账", "账本", "账单", "流水", "财务报表"], "📒"),
    (["打卡", "签到", "考勤", "工时"], "✅"),
    (["待办", "待做", "待处理", "任务清单"], "📝"),
    (["聊天", "闲聊", "对话", "消息", "私信"], "💬"),
    (["角色", "人物", "人设", "NPC", "角色扮演", "人格"], "👤"),
    (["减肥", "瘦身", "减脂", "增肌", "体重", "体脂"], "💪"),
    (["锻炼", "训练", "运动打卡", "晨跑", "夜跑"], "⚽"),
    (["法务", "法律咨询", "律师", "司法", "法治"], "⚖️"),
    (["SEO", "优化", "排名", "搜索引擎", "网站", "谷歌搜索"], "🔍"),
    (["收楼", "交楼", "验楼", "验房师"], "🔍"),
    (["cos", "cosplay", "c服", "漫展"], "🎭"),
    (["书单", "书评", "读后感", "藏书"], "📚"),
    (["茶", "咖啡", "奶茶", "饮品", "茶饮", "调酒", "果汁"], "☕"),
