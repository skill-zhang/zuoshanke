...
const ICON_MAP: Record<string, string> = {
  ...
  extract_text_from_pdf: '📎', analyze_image: '🖼', text_to_speech: '🎤', translate: '🌐', news_summary: '📰', generate_qrcode: '📱', daily_quote: '💬', recipe: '🍳', calculator: '🧮', baike: '📚', image_gen: '🎨', send_email: '📧', express_tracking: '📦',
};
